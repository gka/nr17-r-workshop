...
Anstatt die Eigenschaften nur "statisch" für alle Punkte zu verändern
kann man auch weitere Spalten aus dem Datensatz verwenden und so neue
Dimensionen zu dem Plot hinzufügen. 
...
wir auf die Spalte _Bevölkerungsdichte_ mappen.
...
Farben unserer Wahl und fügen diese dann per `scale_colour_manual`
dem Plot hinzu:
...
Aber leider ist immer noch alles etwas zu unübersichtlich im Plot. 
Also benutzen wir wieder unseren Freund `facet_grid` um die 
Barcodes in unsere vier Gruppen einzuteilen. (Mit `guide=FALSE`
